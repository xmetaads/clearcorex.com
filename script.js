...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'faq.a4': "ClearCorex Desktop is available for Windows 10 and 11 (64-bit). It's a 71 MB native installer, runs fully offline, and never uploads your data anywhere. macOS and Linux versions are on the roadmap.",
    ...
    vi: {
      ...
      'faq.a4': 'ClearCorex Desktop có sẵn cho Windows 10 và 11 (64-bit). File installer native 71 MB, chạy hoàn toàn offline và không bao giờ tải dữ liệu lên đâu. Phiên bản macOS và Linux đang trong roadmap.',
