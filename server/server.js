...
function htmlEmail({ lang }) {
  ...
  const t = isVi ? {
    ...
    qs1: 'Mở file <strong>ClearCorex-Setup-4.0.3.exe</strong> vừa tải về để cài đặt — installer sẽ tự tạo shortcut trên Desktop và Start Menu',
    ...
    troubleBody: 'Nếu installer không tự khởi động hoặc bạn lỡ đóng, hãy tìm file <code>ClearCorex-Setup-4.0.3.exe</code> trong thư mục Downloads và mở lại. Tải lại bất cứ lúc nào tại <a href="https://clearcorex.com" style="color:#3b82f6;text-decoration:none">clearcorex.com</a>.',
    ...
    qs1: 'Open the <strong>ClearCorex-Setup-4.0.3.exe</strong> file you just downloaded — the installer creates Desktop and Start Menu shortcuts automatically',
    ...
    troubleBody: 'If the installer didn\'t auto-launch or you closed it by accident, look for <code>ClearCorex-Setup-4.0.3.exe</code> in your Downloads folder and open it. You can re-download anytime at <a href="https://clearcorex.com" style="color:#3b82f6;text-decoration:none">clearcorex.com</a>.',
